...
// ── Parâmetros de Jogo ────────────────────────────────
#define HP_MAXIMO           30   // 1 LED = 1 ponto de vida (começa com 30)
#define DANO_POR_TIRO       3    // 3 LEDs apagados por tiro direto
#define DANO_DUPLO_FATOR    2    // multiplicador de punição (DANO_DUPLO)
#define DEBOUNCE_HIT_MS     400  // intervalo mínimo entre dois hits (ms)
